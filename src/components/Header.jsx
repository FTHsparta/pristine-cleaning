...
export default function Header() {
  return (
    <header className="bg-blue-700 text-white shadow-md sticky top-0 z-50" style={{height: '9rem'}}>
      <div className="max-w-7xl mx-auto flex items-center justify-between px-3 h-full" style={{height: '100%'}}>
